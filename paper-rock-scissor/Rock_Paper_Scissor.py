...
play_btn.pack()
paper_img = PhotoImage(file = r"paper-rock-scissor/paper.png")
rock_img = PhotoImage(file = r"paper-rock-scissor/rock.png")
scissor_img = PhotoImage(file = r"paper-rock-scissor/scissor.png")
